...
3. Configuration will be saved to `~/.osaconfig`
4. Scripts matching your configuration will be automatically loaded

### Configuration

Scripts are loaded based on boolean flags set in `~/.osaconfig`. This file is automatically generated by the OSA setup wizard and contains flags like:
